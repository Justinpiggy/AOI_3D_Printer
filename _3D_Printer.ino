...
void ShowProgress(int x, int y, int barlen, double progress)
{
  ...
  LCD.setCursor(x, y);
  SerialUSB.println(block_counter);
  SerialUSB.println(block_divider);
      ...
      case 0:
        {
          ...
          if ((buffer_switch == 1) || (command_switch == 1))
          {
            SerialUSB.print("X ");
            SerialUSB.print(current.x);
            SerialUSB.print(" |Y ");
